...
import { chartInk, vegaThemeConfig } from '../../../style/theme';
...
class SunburstChart extends React.Component<Props> {
    ...
    createVisualizationData() {
        ...
        if (operatorIdArray[0] !== "inner") {
            operatorIdArray.unshift("inner");
        }
        if (parentPipelinesArray[0] !== null) {
            parentPipelinesArray.unshift(null);
        }
        if (operatorOccurrencesArray[0] !== null) {
            operatorOccurrencesArray.unshift(null);
        }
        if (pipelineOccurrencesArray[0] !== null) {
            pipelineOccurrencesArray.unshift(null);
        }
