...
export type QueryVariant =
    | BackendQuery<BackendQueryType.GET_EVENTS, EmptyPayload>
    | BackendQuery<BackendQueryType.GET_PIPELINES, EmptyPayload>
    ...
    | BackendQuery<BackendQueryType.other, EmptyPayload>
    ;
...
export function createBackendQuery(query: QueryVariant) {
    ...
    switch (query.type) {
        ...
        case BackendQueryType.GET_OPERATORS:
            return 'operator/op_ext/count_with_mapping?operator/sort?count,desc';
