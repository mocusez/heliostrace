import { BackendQueryType, ProfileType, IChartDataKeyValue, IKpiData, IResult, IResultLoading, ProfileVariant, createProfiles, IOperatorsData, HeatmapsOutlierDetectionDegrees, IKpiValuesFormated, IResultLoadingReadableName, IMetalDispatch, IRooflineData } from ".";
import { ViewType, ChartType } from "./chart_types";
...
export interface AppState {
    ...
    metalDispatches: Array<IMetalDispatch> | undefined;
    rooflineData: IRooflineData | undefined;
