...
import { hoverOpacity } from '../style/theme';
...
export function createColorScales(operatorsId: Array<string>, operatorsGroup: Array<string>, operatorsGroupSorted: Array<string>) {
    ...
    const createBaseOperatorsGroupColors = () => {
        const operatorsGroupBaseColors: IOperatorsGroupBaseColors = {};
        const operatorsGroupCount: IOperatorsGroupCount = {};
    ...
    const createOperatorsIdColorScale = (baseOperatorColors: IBaseOperatorsGroupColors) => {
        ...
        const currentOperatorsGroupCount: IOperatorsGroupCount = {};
