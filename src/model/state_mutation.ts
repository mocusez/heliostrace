import { AppState, createProfiles, ProfileType, IKpiData, IResult, BackendQueryType, IChartDataKeyValue, ViewType, ChartType, IOperatorsData, HeatmapsOutlierDetectionDegrees, IKpiValuesFormated, IResultLoadingReadableName, IMetalDispatch, IRooflineData } from '.';
...
export enum StateMutationType {
    ...
    SET_METAL_DISPATCHES = 'SET_METAL_DISPATCHES',
    SET_ROOFLINE = 'SET_ROOFLINE',
    SET_HELIOS_FILE_PARSING_FINISHED = 'SET_HELIOS_FILE_PARSING_FINISHED',
...
export type StateMutationVariant =
    ...
    | StateMutation<StateMutationType.SET_METAL_DISPATCHES, Array<IMetalDispatch>>
    | StateMutation<StateMutationType.SET_ROOFLINE, IRooflineData | undefined>
    | StateMutation<StateMutationType.SET_HELIOS_FILE_PARSING_FINISHED, boolean>
...
export class AppStateMutation {
    public static reduce(state: AppState, mutation: StateMutationVariant): AppState {
        switch (mutation.type) {
            ...
            case StateMutationType.SET_METAL_DISPATCHES:
                return {
                    ...state,
                    metalDispatches: mutation.data,
                };
            case StateMutationType.SET_ROOFLINE:
                return {
                    ...state,
                    rooflineData: mutation.data,
                };
            case StateMutationType.SET_HELIOS_FILE_PARSING_FINISHED:
                return {
                    ...state,
                    heliosFileParsingFinished: mutation.data,
                };
            ...
            case StateMutationType.SET_RESET_STATE:
                return {
                    ...
                    resultLoading: {},
                    result: undefined,
                    heliosFileParsingFinished: false,
                    file: undefined,
                    queryplanJson: undefined,
                    metalDispatches: undefined,
                    rooflineData: undefined,
                    currentChart: [],
                    loadingChartReadableName: [],
