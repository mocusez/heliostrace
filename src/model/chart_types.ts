...
export enum ChartType {
    ...
    SWIM_LANES_TMAM = "SWIM_LANES_TMAM",
...
export enum ChartTypeReadable {
    ...
    SWIM_LANES_TMAM = "Swim Lanes (TMAM)",
...
export interface ICommonChartProps {
    //key prop forces react to rerender child on change -> combines chartId/width/height/themeVersion
    key: string;
    chartId: number,
    width: number,
    chartType: ChartType,
...
export type ChartComponentVariant =
    ...
    | ChartComponent<ChartType.SWIM_LANES_TMAM | ChartType.SWIM_LANES_MULTIPLE_PIPELINES | ChartType.SWIM_LANES_MULTIPLE_PIPELINES_ABSOLUTE | ChartType.SWIM_LANES_COMBINED_MULTIPLE_PIPELINES | ChartType.SWIM_LANES_COMBINED_MULTIPLE_PIPELINES_ABSOLUTE, ISwimlanesProps>
